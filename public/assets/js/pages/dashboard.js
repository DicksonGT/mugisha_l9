    ...
    var data = [], totalPoints = 300;
     ...
     /*var demo = new CountUp("myTargetElement1", 1.52, 161, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement2", 1, 172, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement3", 24.02, 5209, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement4", 1254, 8210, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement1.1", 1254, 3108, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement1.2", 1254, 3960, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement2.1", 154, 920, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement2.2", 2582, 3929, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement3.1", 2582, 3028, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement3.2", 858, 1929, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement4.1", 244, 1560, 0, 6, options);
        demo.start();
        var demo = new CountUp("myTargetElement4.2", 84, 2194, 0, 6, options);
        demo.start();*/
