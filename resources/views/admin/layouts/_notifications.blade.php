<li class="dropdown notifications-menu">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <span class="label label-warning">{!! $event_count !!}</span>
    </a>
    <ul class=" notifications dropdown-menu">
        <li class="dropdown-title">You have {!! $event_count !!} notifications</li>
        <li>
            ...
            <ul class="menu">
                <li>
                    <i class="livicon danger" data-n="timer" data-s="20" data-c="white"
                       data-hc="white"></i>
                    <a href="#">{!! $event_detail[0]->task_description !!}</a>
                    <small class="pull-right">
                        <span class="livicon paddingright_10" data-n="timer" data-s="10"></span>
                        {!! $event_detail[0]->updated_at !!}
                    </small>
                </li>
                <li>
