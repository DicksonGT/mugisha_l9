        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('products.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                </div>
            </div>
            <br />
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.products.confirm-delete', $product->id) }}" data-toggle="modal" data-target="#delete_confirm">
