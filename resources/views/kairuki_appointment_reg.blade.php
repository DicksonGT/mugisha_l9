    ...
    <div class="content paddingleft_right15 container">
        ...
        <div class="row">
            <div class="">
                ...
                <h3 class="text-primary">Weka Appointment</h3>
                <!-- Notifications -->
                ...
                <form action="{{ route('kairuki_register') }}" method="POST">
                    ...
                    <div class="form-group {{ $errors->first('date_of_birth', 'has-error') }}" style="text-align:left  ">
                        <div style="text-align:left">Tarehe ya Appointment</div>

                        {!! Form::selectYear('year', 2023, 2023) !!}
                        {!! Form::selectMonth('month') !!}
                        {!! Form::selectRange('day', 1, 31) !!}
                        <label>Muda wa appointment saa: </label>
                        {!! Form::selectRange('hour', 3, 12) !!}
                    </div>
