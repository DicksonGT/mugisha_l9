...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="list-group">
                <li onclick="location.href='kairuki_reg'" class="list-group-item" id="#">Jiandikishe kwa huduma</li>
                <li onclick="location.href='ratiba_madaktari'" class="list-group-item" id="#">Ratiba ya Madaktari</li>
                <li href="#" class="list-group-item" id="#">Madaktari waliopo muda huu</li>
                <li onclick="location.href='kairuki_appointment_reg'" class="list-group-item" id="#">Weka Appointment na daktari</li>
                <li onclick="location.href='kpl'" class="list-group-item" id="#">Kiwanda cha Dawa (KPL)</li>
