...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-default container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><img src="{{ asset('assets/images/logo.png') }}" alt="logo" class="logo_position">
                </a>
            </div>
    ...
    <!--global js starts-->
    <!-- <script src="{{ asset('assets/js/jquery-3.6.2.min.js') }}" type="text/javascript"></script> -->
